...
in
{
  config = {
    ...
    xdg.configFile."zellij/config.kdl".text = with config.lib.stylix.colors; ''
      ...
      simplified_ui  false
      scrollback_editor "/home/wug/.nix-profile/bin/nvim"
      pane_frames false
      ...
      keybinds {
        normal {
          ...
          bind "Alt g" {
            LaunchOrFocusPlugin "https://github.com/laperlej/zellij-sessionizer/releases/download/v0.4.3/zellij-sessionizer.wasm" {
              floating true
              move_to_focused_tab true
              cwd "/"
              root_dirs "/home/wug/workspace/rf/struktur;/etc/nixos/;/home/wug/workspace/gh"
            };
            SwitchToMode "Normal";
          }
          bind "Ctrl f" {
